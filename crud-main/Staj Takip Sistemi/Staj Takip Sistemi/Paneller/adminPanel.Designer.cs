namespace Staj_Takip_Sistemi
{
	partial class adminPanel
	{
		...
		private void InitializeComponent()
		{
			...
			this.personelTableAdapter = new Staj_Takip_Sistemi.ProjeDataTableAdapters.PersonelTableAdapter();
			this.label1 = new System.Windows.Forms.Label();
			this.comboBox1 = new System.Windows.Forms.ComboBox();
			this.label2 = new System.Windows.Forms.Label();
			this.personelNo = new System.Windows.Forms.TextBox();
			this.personelNotxt = new System.Windows.Forms.Label();
			this.personeltxt = new System.Windows.Forms.Label();
			this.personelDepartman = new System.Windows.Forms.TextBox();
			this.personelSoyad = new System.Windows.Forms.TextBox();
			this.personelDepartmantxt = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.personelSoyadtxt = new System.Windows.Forms.Label();
			this.personelAd = new System.Windows.Forms.TextBox();
			this.personelAdtxt = new System.Windows.Forms.Label();
			...
			this.yoneticiNo = new System.Windows.Forms.TextBox();
			this.yoneticiNotxt = new System.Windows.Forms.Label();
			this.yoneticitxt = new System.Windows.Forms.Label();
			this.yoneticiDepartman = new System.Windows.Forms.TextBox();
			this.yoneticiSoyad = new System.Windows.Forms.TextBox();
			this.yoneticiDepartmantxt = new System.Windows.Forms.Label();
			...
			this.exitBtn.Location = new System.Drawing.Point(1309, 12);
			...
			this.minimizeBtn.Location = new System.Drawing.Point(1260, 19);
			...
			this.personelBindingSource.DataSource = this.projeData;
			// 
			...
			// label1
			// 
			this.label1.Font = new System.Drawing.Font("Microsoft YaHei", 25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(162)));
			this.label1.ForeColor = System.Drawing.Color.White;
			this.label1.Location = new System.Drawing.Point(461, 57);
			this.label1.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.label1.Name = "label1";
			this.label1.Size = new System.Drawing.Size(781, 122);
			this.label1.TabIndex = 45;
			this.label1.Text = "Kıyı Emniyeti Admin Paneli";
			// 
			// comboBox1
			// 
			this.comboBox1.FormattingEnabled = true;
			this.comboBox1.Location = new System.Drawing.Point(471, 226);
			...
			this.label2.Location = new System.Drawing.Point(465, 179);
			this.label2.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.label2.Name = "label2";
			this.label2.Size = new System.Drawing.Size(563, 34);
			this.label2.TabIndex = 47;
			this.label2.Text = "İşlem Yapılacak Birimi Seçin:";
			// 
			// personelNo
			// 
			...
			this.personelNo.TabIndex = 76;
			this.personelNo.Visible = false;
			this.personelNo.TextChanged += new System.EventHandler(this.stajyerNo_TextChanged);
			// 
			// personelNotxt
			// 
			...
			this.personelNotxt.TabIndex = 75;
			this.personelNotxt.Text = "Personel No:";
			this.personelNotxt.Visible = false;
			this.personelNotxt.Click += new System.EventHandler(this.label8_Click);
			// 
			// personeltxt
			// 
			this.personeltxt.Font = new System.Drawing.Font("Arial Rounded MT Bold", 16.2F, System.Drawing.FontStyle.Italic, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.personeltxt.ForeColor = System.Drawing.Color.White;
			this.personeltxt.Location = new System.Drawing.Point(588, 301);
			this.personeltxt.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.personeltxt.Name = "personeltxt";
			this.personeltxt.Size = new System.Drawing.Size(420, 38);
			this.personeltxt.TabIndex = 74;
			this.personeltxt.Text = "Personel İşlemleri";
			this.personeltxt.Visible = false;
			this.personeltxt.Click += new System.EventHandler(this.label7_Click);
			// 
			// personelDepartman
			// 
			...
			this.personelDepartman.TabIndex = 73;
			this.personelDepartman.Visible = false;
			this.personelDepartman.TextChanged += new System.EventHandler(this.stajyerDepartman_TextChanged);
			// 
			// personelSoyad
			// 
			...
			this.personelSoyad.TabIndex = 72;
			this.personelSoyad.Visible = false;
			this.personelSoyad.TextChanged += new System.EventHandler(this.stajyerSoyad_TextChanged);
			// 
			// personelDepartmantxt
			// 
			...
			this.personelDepartmantxt.TabIndex = 71;
			this.personelDepartmantxt.Text = "Departmanı:";
			this.personelDepartmantxt.Visible = false;
			this.personelDepartmantxt.Click += new System.EventHandler(this.label5_Click);
			// 
			// label4
			// 
			...
			this.personelSoyadtxt.TabIndex = 69;
			this.personelSoyadtxt.Text = "Soyadı:";
			this.personelSoyadtxt.Visible = false;
			this.personelSoyadtxt.Click += new System.EventHandler(this.label3_Click);
			// 
			// personelAd
			// 
			...
			this.personelAd.TabIndex = 68;
			this.personelAd.Visible = false;
			this.personelAd.TextChanged += new System.EventHandler(this.stajyerAd_TextChanged);
			// 
			// personelAdtxt
			// 
			...
			this.personelAdtxt.TabIndex = 67;
			this.personelAdtxt.Text = "Adı:";
			this.personelAdtxt.Visible = false;
			this.personelAdtxt.Click += new System.EventHandler(this.label6_Click);
			// 
			// personelSilbtn
			// 
			this.personelSilbtn.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(175)))), ((int)(((byte)(211)))), ((int)(((byte)(226)))));
			this.personelSilbtn.FlatAppearance.BorderSize = 0;
			...
			this.personelSilbtn.TabIndex = 98;
			this.personelSilbtn.Text = "Personel Sil";
			this.personelSilbtn.UseVisualStyleBackColor = false;
			this.personelSilbtn.Visible = false;
			// 
			// personelEklebtn
			// 
			this.personelEklebtn.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(175)))), ((int)(((byte)(211)))), ((int)(((byte)(226)))));
			this.personelEklebtn.FlatAppearance.BorderSize = 0;
			...
			this.personelEklebtn.TabIndex = 97;
			this.personelEklebtn.Text = "Personel Ekle";
			this.personelEklebtn.UseVisualStyleBackColor = false;
			this.personelEklebtn.Visible = false;
			// 
			// personelGuncellebtn
			// 
			this.personelGuncellebtn.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(175)))), ((int)(((byte)(211)))), ((int)(((byte)(226)))));
			this.personelGuncellebtn.FlatAppearance.BorderSize = 0;
			...
			this.personelGuncellebtn.TabIndex = 96;
			this.personelGuncellebtn.Text = "Personel Güncelle";
			this.personelGuncellebtn.UseVisualStyleBackColor = false;
			this.personelGuncellebtn.Visible = false;
			// 
			// yoneticiSilbtn
			// 
			this.yoneticiSilbtn.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(175)))), ((int)(((byte)(211)))), ((int)(((byte)(226)))));
			this.yoneticiSilbtn.FlatAppearance.BorderSize = 0;
			...
			this.yoneticiSilbtn.TabIndex = 111;
			...
			// yoneticiEklebtn
			// 
			this.yoneticiEklebtn.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(175)))), ((int)(((byte)(211)))), ((int)(((byte)(226)))));
			this.yoneticiEklebtn.FlatAppearance.BorderSize = 0;
			...
			this.yoneticiEklebtn.TabIndex = 110;
			this.yoneticiEklebtn.Text = "Yönetici Ekle";
			this.yoneticiEklebtn.UseVisualStyleBackColor = false;
			this.yoneticiEklebtn.Visible = false;
			this.yoneticiEklebtn.Click += new System.EventHandler(this.yoneticiEklebtn_Click);
			// 
			// yoneticiGuncellebtn
			// 
			this.yoneticiGuncellebtn.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(175)))), ((int)(((byte)(211)))), ((int)(((byte)(226)))));
			this.yoneticiGuncellebtn.FlatAppearance.BorderSize = 0;
			...
			this.yoneticiGuncellebtn.TabIndex = 109;
			...
			this.yoneticiNo.TabIndex = 108;
			this.yoneticiNo.Visible = false;
			// 
			// yoneticiNotxt
			// 
			...
			// yoneticitxt
			// 
			this.yoneticitxt.Font = new System.Drawing.Font("Arial Rounded MT Bold", 16.2F, System.Drawing.FontStyle.Italic, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.yoneticitxt.ForeColor = System.Drawing.Color.White;
			this.yoneticitxt.Location = new System.Drawing.Point(597, 301);
			this.yoneticitxt.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.yoneticitxt.Name = "yoneticitxt";
			this.yoneticitxt.Size = new System.Drawing.Size(401, 38);
			this.yoneticitxt.TabIndex = 106;
			this.yoneticitxt.Text = "Yönetici İşlemleri";
			this.yoneticitxt.Visible = false;
			// 
			// yoneticiDepartman
			// 
			...
			this.yoneticiDepartman.TabIndex = 105;
			this.yoneticiDepartman.Visible = false;
			// 
			// yoneticiSoyad
			// 
			...
			this.yoneticiSoyad.TabIndex = 104;
			this.yoneticiSoyad.Visible = false;
			// 
			// yoneticiDepartmantxt
			// 
			...
			this.yoneticiSoyaditxt.TabIndex = 101;
			this.yoneticiSoyaditxt.Text = "Soyadı:";
			this.yoneticiSoyaditxt.Visible = false;
			// 
			// yoneticiAd
			// 
			...
			this.yoneticiAd.TabIndex = 100;
			this.yoneticiAd.Visible = false;
			// 
			// yoneticiAditxt
			// 
			...
			this.Controls.Add(this.yoneticiNo);
			this.Controls.Add(this.yoneticiNotxt);
			this.Controls.Add(this.yoneticitxt);
			this.Controls.Add(this.yoneticiDepartman);
			this.Controls.Add(this.yoneticiSoyad);
			this.Controls.Add(this.yoneticiDepartmantxt);
			this.Controls.Add(this.yoneticiSoyaditxt);
			this.Controls.Add(this.yoneticiAd);
			this.Controls.Add(this.yoneticiAditxt);
			...
			this.Controls.Add(this.personelDepartman);
			this.Controls.Add(this.personelSoyad);
			this.Controls.Add(this.personelDepartmantxt);
		...
		private ProjeDataTableAdapters.PersonelTableAdapter personelTableAdapter;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.ComboBox comboBox1;
		private System.Windows.Forms.Label label2;
		private System.Windows.Forms.TextBox personelNo;
		private System.Windows.Forms.Label personelNotxt;
		private System.Windows.Forms.Label personeltxt;
		private System.Windows.Forms.TextBox personelDepartman;
		private System.Windows.Forms.TextBox personelSoyad;
		private System.Windows.Forms.Label personelDepartmantxt;
		private System.Windows.Forms.Label label4;
		private System.Windows.Forms.Label personelSoyadtxt;
		private System.Windows.Forms.TextBox personelAd;
		private System.Windows.Forms.Label personelAdtxt;
		...
		private System.Windows.Forms.TextBox yoneticiNo;
		private System.Windows.Forms.Label yoneticiNotxt;
		private System.Windows.Forms.Label yoneticitxt;
		private System.Windows.Forms.TextBox yoneticiDepartman;
		private System.Windows.Forms.TextBox yoneticiSoyad;
		private System.Windows.Forms.Label yoneticiDepartmantxt;
